  ...
  <div class="container">
    <form method="post">
      <div class="row">
        ...
        <div class="col s12">
          <router-link class="btn-small grey" :to="getRef('/userAccount')">Back</router-link>
          <router-link class="btn-small" :to="`/userAccount/edit/${userAccount.id}?ref=${encodeURIComponent(getRef('/userAccount'))}`">Edit</router-link>
        </div>
      </div>
    </form>
  </div>
