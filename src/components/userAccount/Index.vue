        ...
        <tbody>
          <tr v-for="userAccount in userAccounts" :key="userAccount">
            ...
            <td class="center-align">
              <router-link class="btn-small grey" :to="`/userAccount/${userAccount.id}`" title="View"><i class="mdi mdi-eye"></i></router-link>
              <router-link class="btn-small" :to="`/userAccount/edit/${userAccount.id}`" title="Edit"><i class="mdi mdi-pencil"></i></router-link>
              <router-link class="btn-small red" :to="`/userAccount/delete/${userAccount.id}`" title="Delete"><i class="mdi mdi-close-thick"></i></router-link>
            </td>
          </tr>
        </tbody>
      </table>
