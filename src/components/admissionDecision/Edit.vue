    ...
    <form method="post" @submit.prevent="edit()">
      <div class="row">
        <div class="col m6 l4">
          ...
          <input readonly id="admission_decision_id" name="id" v-model="admissionDecision.id" type="number" required />
...
export default {
  ...
  methods: {
    ...
    edit() {
      Service.edit(this.$route.params.id, this.admissionDecision).then(() => {
